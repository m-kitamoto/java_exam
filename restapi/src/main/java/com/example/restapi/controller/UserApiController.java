...
import com.example.restapi.dto.UserSearchCriteria;
...
public class UserApiController {
    ...
    // 引数や戻り値は適宜修正してください
    @GetMapping("/search")
    public ResponseEntity<List<UserResponse>> searchUsers(@Valid @ModelAttribute UserSearchCriteria criteria) {
        List<User> users = userService.searchUsers(new User(criteria.getName(), criteria.getEmail()));
